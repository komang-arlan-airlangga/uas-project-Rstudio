...
Hasil analisis menunjukkan bahwa data biaya akuisisi pelanggan memiliki tingkat variasi yang tinggi dan tidak mengikuti distribusi normal, yang mengindikasikan adanya perbedaan strategi dan skala bisnis antar startup SaaS. Meskipun distribusi data tidak normal, analisis korelasi dan regresi memperlihatkan adanya **hubungan linear yang sangat kuat dan konsisten** antara biaya akuisisi pelanggan dan pendapatan tahunan. Nilai korelasi sebesar **0,996** serta pola scatter plot yang membentuk garis naik yang jelas menunjukkan bahwa peningkatan biaya akuisisi hampir selalu diikuti oleh peningkatan pendapatan.

Model regresi yang dibangun mampu menjelaskan **99,1% variasi pendapatan tahunan**, yang menandakan bahwa biaya akuisisi pelanggan merupakan faktor dominan dalam menentukan besarnya pendapatan startup pada dataset ini. Koefisien regresi yang mendekati satu menunjukkan bahwa hubungan kedua variabel bersifat proporsional, sehingga setiap tambahan investasi pada akuisisi pelanggan memberikan peningkatan pendapatan yang hampir sebanding. Secara keseluruhan, wawasan utama dari analisis ini adalah bahwa efektivitas dan besarnya investasi dalam akuisisi pelanggan sangat berpengaruh terhadap kinerja finansial startup SaaS, sehingga keputusan pengalokasian biaya pemasaran perlu direncanakan secara matang dengan mempertimbangkan dampaknya terhadap pendapata
